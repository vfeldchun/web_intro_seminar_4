...
<html>
  ...
  <body class="w3-light-grey">
    <?php 
    $titleNameArray = ['Linux Administrator', 'Network Administrator', 'C# Backend Developer'];
    $datesArray = ['Jun 2003 - Dec 2005', 'Jan 2006 - Jul 2009', 'Aug 2009 - '];
    $jobDescArray = ['Administration of RHEL and corporate e-mail',
                     'Administration of Cisco routers and switches, Continent CryptoGates',
                     'Development of backend for IT Infrastructure monitoring solution'];
?>
    <!-- Page Container -->
      ...
      <div class="w3-row-padding">
        ...
        <div class="w3-twothird">
          <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <div class="w3-container">
              <h5 class="w3-opacity">
                <b><?= $titleNameArray[2] ?></b>
              </h5>
              <h6 class="w3-text-teal">
                <i class="fa fa-calendar fa-fw w3-margin-right"></i
                ><?= $datesArray[2] ?><span class="w3-tag w3-teal w3-round"
                  >Current</span
                >
              </h6>
              <p><?= $jobDescArray[2] ?></p>
